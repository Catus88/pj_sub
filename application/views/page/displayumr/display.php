  ...
  if (document.getElementById('total').value == "0")
 {
  ...
  document.form1.submit();
   ...
   <?php  
    ...
    $querystr_SOPU0 = odbc_exec($conn,"select *  from smcdta.SOPU0 where  U0DSTC = '".trim($CADSTC)."' ");
...
$O1ECNM_COM  =   iconv("windows-874", "utf-8", $SOPO1_test["O1ECNM"]);
     ...
     ?>
                           ...
                           <!--  <div class="col col-md-2"><label for="text-input" class=" form-control-label">SMC A/C No.  :</label></div>
                            ...
                            <div class="col-24 col-md-4"> <input type="text" id="User_Code_Dist" readonly="" disabled="" name="User_Code_Dist" value="<?php echo $CFUSRC; ?>" placeholder="Distributor End User Code "    class="form-control"></div>
