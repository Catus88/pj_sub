...
$DGEMA1  = iconv("windows-874", "utf-8", $result_sopdg2["DGEMA1"]); 
  ...
  $querystr_SOPCA = odbc_exec($conn,"select *  from smcdta.sopo1 where  O1CUSN = '".$CACUSN_trim."' ");
  ...
  $querystr_SOPOH = odbc_exec($conn,"select  OHCCTX,OHSTRG,OHGRP1,OHGRP2  from smcdta.SOPOH where  OHCUSN = '".$CACUSN_trim."' ");
 ...
 ?> 
   ...
   <div class="row form-group">
                            ...
                            <div class="col-24 col-md-2"><input type="text"  readonly="" id="Distributor" placeholder="Distributor Code"   
                              ...
                              value="<?php  echo  $CADSTC_trim  ;?>" class="form-control"></div>
...
?>
                            ...
                            <div class="col-24 col-md-2"> <input type="text" id="customer_cusn"    name="customer_cusn"  maxlength="15" value="<?php echo $result_tax; ?>" placeholder="Search Tax ID  "   class="form-control"></div>


                             

                             <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Tax  Branch  Code:</label></div>
                            <div class="col-24 col-md-2"> <input type="text" id="customer_cusn1"    name="customer_cusn1" maxlength="5" value="<?php echo $result_tax1; ?>" placeholder="Search   Brach   Code "   class="form-control"></div>
                         ...
                         <div class="row form-group">
                            ...
                            <div class="col-24 col-md-2"> <input type="text" id="User_Code_Dist" required  name="User_Code_Dist"  maxlength="10"   value="<?php echo $CFUSRC; ?>" placeholder="Distributor End User Code "    class="form-control"></div>
  ...
  <!-- Modal -->
                            ...
                            <div class="col-24 col-md-4"> <input type="text" id="O1CUSN"  maxlength="8"    readonly=""   name="O1CUSN" value="<?php echo $O1CUSN; ?>" placeholder="SMC A/C No. "   class="form-control"></div>
 ...
 <div class="row form-group">
                   ...
                   <div class="row form-group">
                        ...
                        <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"><input type="text" id="Sales_Man_Dis" required   name="Sales_Man_Dis"  maxlength="60"  value="<?php echo $CCOCR12; ?>" placeholder="Sales Man(Dis)"  class="form-control"></div>
    ...
    <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"><input type="text" id="Contact_Name" required  name="Contact_Name" maxlength="40"  value="<?php echo $DGCENM; ?>" placeholder="Contact Name"   class="form-control"></div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"><input type="text" id="Position" maxlength="40"   required  name="Position" value="<?php  echo $DGPOEN ?>" placeholder="Position"   class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Tel :</label></div>
                            <div class="col-24 col-md-4"><input type="text" id="Tel"  maxlength="20" required   name="Tel" value="<?php  echo $DGTLNO ?>" placeholder="Tel"  class="form-control"></div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            ...
                            <div class="col-24 col-md-4"> <input type="text" id="Year"  maxlength="4" required  pattern="[0-9]{4}"   name="Year" value="<?php echo $CCCYEAR; ?>" placeholder="Fiscal Year" class="form-control"></div>
                            ...
                            <div class="col-24 col-md-4"> <input type="number" id="input1" pattern="[0-9]"  max="99999999999"     Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="Apr" value="<?php echo $CCCMN01; ?>"  placeholder="April" class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">May :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input2"  pattern="[0-9]" max="99999999999"  Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="May" value="<?php echo $CCCMN02; ?>" placeholder="May"  class="form-control"></div>
                        </div>
                             <div class="row form-group">

                           <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Jun :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input3" pattern="[0-9]" max="99999999999"   Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="Junl" value="<?php echo $CCCMN03; ?>" placeholder="June"  class="form-control"></div>

                              <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Jul :</label></div>
                            <div class="col-24 col-md-4"><input type="number"  id="input4"  pattern="[0-9]" max="99999999999"   Onchange="JavaScript:return fnccheck();"   maxlength="13"  name="Jul" value="<?php echo $CCCMN04; ?>" placeholder="July"  class="form-control"></div>

                        </div>
                             <div class="row form-group">

                           <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Aug :</label></div>
                            <div class="col-24 col-md-4"><input type="number"  id="input5" pattern="[0-9]"  max="99999999999"   Onchange="JavaScript:return fnccheck();"  maxlength="13"    name="Aug" value="<?php echo $CCCMN05; ?>" placeholder="Auguest"  class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Sep :</label></div>
                            <div class="col-24 col-md-4"> <input type="number"  id="input6" pattern="[0-9]"  max="99999999999"   Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Sep" value="<?php echo $CCCMN06; ?>" placeholder="September"  class="form-control"></div>
                        </div>
                             <div class="row form-group">
                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Oct :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input7"  pattern="[0-9]" max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Oct" value="<?php echo $CCCMN07; ?>" placeholder="Octorber"  class="form-control">  </div>

                                  <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Nov :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input8"   pattern="[0-9]" max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"  name="Nov" value="<?php echo $CCCMN08; ?>" placeholder="November"  class="form-control"> </div>
                        </div>
                             <div class="row form-group">

                             <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Dec :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input9"  pattern="[0-9]"  max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Dec" value="<?php echo $CCCMN09; ?>" placeholder="Dectember"  class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label"> Jan :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input10"  pattern="[0-9]"  max="99999999999"   Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Jan" value="<?php echo $CCCMN10; ?>" placeholder="January"  class="form-control"></div>
                        </div>
                             <div class="row form-group">

                          <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Feb : </label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input11" pattern="[0-9]"  max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"  name="Feb" value="<?php echo $CCCMN11; ?>" placeholder="February"  class="form-control"></div>

                              <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Mar :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input12" pattern="[0-9]"  max="99999999999"  Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="Mar" value="<?php echo $CCCMN12; ?>" placeholder="March"  class="form-control"></div>
                        </div>
                         <div class="row form-group">
