...
<!-- <body onload="javascript:check_usercode();" > -->
<body> 
   ...
   <div class="row form-group">
           ...
           <!--        <button id="execute_search1" type="button" class="btn btn-primary btn-sm">
               ...
               <a href="./search.php"  class="btn btn-warning btn-sm  " >Search by Username</a>
                            ...
                            <div class="col-24 col-md-2"> <input type="text" id="O1CUSN" maxlength="8"  readonly=""   name="O1CUSN" value=" " placeholder="SMC A/C No."   class="form-control"></div>
 ...
 <div class="row form-group">
                   ...
                   <div class="row form-group">
                         ...
                         <div class="row form-group">
                            ...
                            <input type="text" id="OHCCTX1" hidden  readonly="" name="OHCCTX1" value=" "  > 
                              


                                
                           <input type="text" id="OHSTRG1"   hidden readonly="" name="OHSTRG1" value=" " > 
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"><input type="text" id="Sales_Man_Dis"     name="Sales_Man_Dis"   maxlength="60"  value=" " placeholder="Sales Man(Dis)"  class="form-control"></div>
