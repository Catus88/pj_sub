   ...
   <div class="row form-group">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-24 col-md-2"> <input type="text" id="customer_cusn"    name="customer_cusn"  maxlength="15" value=" " placeholder="Search Tax ID  "   class="form-control"></div>


                             

                             <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Tax  Branch  Code:</label></div>
                            <div class="col-24 col-md-2"> <input type="text" id="customer_cusn1"    name="customer_cusn1" maxlength="5" value=" " placeholder="Search   Brach   Code "   class="form-control"></div>
                         ...
                         <div class="row form-group">
                            ...
                            <div class="col-24 col-md-2"> <input type="text" id="User_Code_Dist" required  name="User_Code_Dist"  maxlength="10"   value=" " placeholder="Distributor End User Code "    class="form-control"></div>
                                  <div class="col col-md-2">
  
  <!-- Trigger the modal with a button -->
  <a href="./search_edit_ad.php"    class="btn btn-warning  " >Search by Username</a>
  ...
  <!-- Modal -->
                            ...
                            <div class="col-24 col-md-4"> <input type="text" id="O1CUSN"  maxlength="8"    readonly=""   name="O1CUSN" value=" " placeholder="SMC A/C No. "   class="form-control"></div>
 ...
 <div class="row form-group">
                   ...
                   <div class="row form-group">
                        ...
                        <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"><input type="text" id="Sales_Man_Dis" required   name="Sales_Man_Dis"  maxlength="60"  value=" " placeholder="Sales Man(Dis)"  class="form-control"></div>
    ...
    <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"><input type="text" id="Contact_Name" required  name="Contact_Name" maxlength="40"  value=" " placeholder="Contact Name"   class="form-control"></div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"><input type="text" id="Position" maxlength="40"   required  name="Position" value=" " placeholder="Position"   class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Tel :</label></div>
                            <div class="col-24 col-md-4"><input type="text" id="Tel"  maxlength="20" required   name="Tel" value=" " placeholder="Tel"  class="form-control"></div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            ...
                            <div class="col-24 col-md-4"> <input type="text" id="Year"  maxlength="4" required  pattern="[0-9]{4}"   name="Year" value=" " placeholder="Fiscal Year" class="form-control"></div>
                            ...
                            <div class="col-24 col-md-4"> <input type="number" id="input1" pattern="[0-9]"  max="99999999999"     Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="Apr" value=" "  placeholder="April" class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">May :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input2"  pattern="[0-9]" max="99999999999"  Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="May" value=" " placeholder="May"  class="form-control"></div>
                        </div>
                             <div class="row form-group">

                           <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Jun :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input3" pattern="[0-9]" max="99999999999"   Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="Junl" value=" " placeholder="June"  class="form-control"></div>

                              <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Jul :</label></div>
                            <div class="col-24 col-md-4"><input type="number"  id="input4"  pattern="[0-9]" max="99999999999"   Onchange="JavaScript:return fnccheck();"   maxlength="13"  name="Jul" value=" " placeholder="July"  class="form-control"></div>

                        </div>
                             <div class="row form-group">

                           <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Aug :</label></div>
                            <div class="col-24 col-md-4"><input type="number"  id="input5" pattern="[0-9]"  max="99999999999"   Onchange="JavaScript:return fnccheck();"  maxlength="13"    name="Aug" value=" " placeholder="Auguest"  class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Sep :</label></div>
                            <div class="col-24 col-md-4"> <input type="number"  id="input6" pattern="[0-9]"  max="99999999999"   Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Sep" value=" " placeholder="September"  class="form-control"></div>
                        </div>
                             <div class="row form-group">
                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Oct :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input7"  pattern="[0-9]" max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Oct" value=" " placeholder="Octorber"  class="form-control">  </div>

                                  <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Nov :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input8"   pattern="[0-9]" max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"  name="Nov" value=" " placeholder="November"  class="form-control"> </div>
                        </div>
                             <div class="row form-group">

                             <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Dec :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input9"  pattern="[0-9]"  max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Dec" value=" " placeholder="Dectember"  class="form-control"></div>

                               <div class="col col-md-2"><label for="disabled-input" class=" form-control-label"> Jan :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input10"  pattern="[0-9]"  max="99999999999"   Onchange="JavaScript:return fnccheck();"   maxlength="13"   name="Jan" value=" " placeholder="January"  class="form-control"></div>
                        </div>
                             <div class="row form-group">

                          <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Feb : </label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input11" pattern="[0-9]"  max="99999999999"  Onchange="JavaScript:return fnccheck();"   maxlength="13"  name="Feb" value=" " placeholder="February"  class="form-control"></div>

                              <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Mar :</label></div>
                            <div class="col-24 col-md-4"><input type="number" id="input12" pattern="[0-9]"  max="99999999999"  Onchange="JavaScript:return fnccheck();"  maxlength="13"   name="Mar" value="  " placeholder="March"  class="form-control"></div>
                        </div>
                         <div class="row form-group">

                            <div class="col col-md-2"><label for="disabled-input" class=" form-control-label">Total Budget  Amount :</label></div>
                            <div class="col-24 col-md-4"><input type="text"  required   maxlength="4" readonly=""   name="total" id="total" value=" " placeholder="Total" class="form-control"> </div>
 ...
 <div class="row form-group">
                    ...
                    <div class="row form-group">
                       ...
                       <div class="card-footer" align="center">
                        <button type="submit" formaction="./update_data_edit_ad.php" class="btn btn-primary btn-sm">
