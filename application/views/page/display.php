  ...
  <![endif]-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Display User Master Registration Data Entry</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a >Dispaly User Master Registration Data Entry</a></li>
   ...
   <div class="row form-group">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-24 col-md-4"> <input type="text" id="User_Code_Dist" readonly="" disabled="" name="User_Code_Dist" value=" " placeholder="Distributor End User Code "    class="form-control"></div>
