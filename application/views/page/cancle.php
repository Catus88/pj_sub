                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Delete User Master Registration Data Entry</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a  >Delete User Master Registration Data Entry</a></li>
 ...
 <div class="row form-group">
                   ...
                   <div class="row form-group">
                       ...
                       <div class="card-footer" align="center">
                        <button type="submit" formaction="./update_data.php" class="btn btn-primary btn-sm">
