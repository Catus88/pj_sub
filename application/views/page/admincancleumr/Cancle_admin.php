...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
 ...
 <div class="row form-group">
                   ...
                   <div class="row form-group">
                                          ...
                                          <?php     echo  "  <datalist id='brow_cancle'> <option value=''>Please Select</option>   </strong> "?>


                                                                           <?php
                                                                            $str_comment = odbc_exec($conn, "select * from smcdta.sopex where EXEXTP  = 'CCUR'   ");
                                                                            while ($resu_comment = odbc_fetch_array($str_comment)) {
                                                                            $result_com =  iconv( "windows-874" , "utf-8", $resu_comment["EXEXCD"]);
                                                                          $result_O1CUSN =  iconv( "windows-874" , "utf-8", $resu_comment["EXEDES"]);

                                                                           echo "   <option value='".$result_O1CUSN."'   data-value='".$result_O1CUSN."'>".$result_O1CUSN."</option>     ";
                                                                          } ?>
