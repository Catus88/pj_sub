                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Search Master Registration Data Entry</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
   ...
   <div class="row form-group">
     ...
     <form action="./search.php" method="post"> 
                            ...
                            <div class="col-24 col-md-8"><input type="text" id="User_name"    name="User_name" value="<?php echo $_SESSION["User_name"] ?>" placeholder="User name"  class="form-control">
                             ...
                             <!--  <div class="col-24 col-md-8"><input type="text" id="User_name"    name="User_name" value="<?php echo $_POST['customer_cusn1'] ?>" placeholder="User name"  class="form-control">-->
                            </div>
...
if ( $_POST["User_name"] != "" ) {
     ...
     $sopo1_query = odbc_exec( $conn , "  select  O1ECNM,O1TCNM,O1CENM,O1CTNM,O1CUSN ,  OHCCTX,OHSTRG,OHCUSN    from  smcdta.sopo1 a
   ...
   while (  $result = odbc_fetch_array($sopo1_query) ) {
               ...
               echo    "
                     <tr>
                        ...
                        <td> <button class='btn btn-success btn-sm' formaction='./index_add.php?OHCCTX=". trim($result["OHCCTX"]) ."&OHSTRG=". trim($OHSTRG) ."&O1CUSN=". trim($result["O1CUSN"]) ."' >Select this user</button>  <button class='btn btn-primary btn-sm' formaction='./search_page1.php?O1CUSN=".trim($result["O1CUSN"]) ."' >More Detail</button>  </td>
    ...
    <div class="row form-group">
                     ...
                     <a class="btn btn-danger btn-sm" href = http://mail.smcthai.co.th:8082/pj_mail/M_UMR/WEB/index_add.php>  Back
                        </a>
